                ...
                Array.isArray(l.x))
                    for (var g = 0; g < l.x.length; g++)
                        if (!(l.x[g] < 0 || l.x[g] > o.globals.gridWidth || l.y[g] < 0 || l.y[g] > o.globals.gridHeight)) {
                            ...
                            if ("line" !== o.config.chart.type && "area" !== o.config.chart.type || o.globals.comboCharts || o.config.tooltip.intersect || (f += " no-pointer-events"),
                            (Array.isArray(o.config.markers.size) ? o.globals.markers.size[e] > 0 : o.config.markers.size > 0) || r || d) {
                                ...
                                o.config.series[n].data[u] && (o.config.series[n].data[u].fillColor && (p.pointFillColor = o.config.series[n].data[u].fillColor),
                                o.config.series[n].data[u].strokeColor && (p.pointStrokeColor = o.config.series[n].data[u].strokeColor)),
                                a && (p.pSize = a),
      ...
      , ut = function() {
        ...
        return r(t, [{
            ...
            value: function(t, e) {
                ...
                if (i.globals.isXNumeric ? (o && !d && (n -= s % 2 != 0 ? h / 2 : 0),
      ...
      , yt = function() {
        ...
        return r(t, [{
            ...
            value: function(t) {
                ...
                I.count > 0 && s >= S.globals.dataPoints - I.count && (P.node.setAttribute("stroke-dasharray", I.dashArray),
                P.node.setAttribute("stroke-width", I.strokeWidth),
                P.node.setAttribute("fill-opacity", I.fillOpacity)),
                ...
                return null !== T.dataLabels && y.add(T.dataLabels),
        ...
        return r(s, [{
            ...
            value: function(t, i, a) {
                ...
                for (var c = o.group({
                    ...
                    var n, h, d, g, u = void 0, f = void 0, p = [], b = [], v = r.globals.comboCharts ? a[i] : i, m = o.group({
                        class: "apexcharts-series",
            ...
            value: function(t) {
                ...
                for (var M = n, z = 0; z < a; z++) {
                    ...
                    if (w.config.chart.stacked)
                        ...
                        f = this.zeroY;
                    X ? n = f - T / A[this.yaxisIndex] + 2 * (this.isReversed ? T / A[this.yaxisIndex] : 0) : (n = f - i[r][z + 1] / A[this.yaxisIndex] + 2 * (this.isReversed ? i[r][z + 1] / A[this.yaxisIndex] : 0),
                    "rangeArea" === e && (M = f - y[r][z + 1] / A[this.yaxisIndex] + 2 * (this.isReversed ? y[r][z + 1] / A[this.yaxisIndex] : 0))),
                    p.push(o),
                    b.push(n);
        ...
        return r(t, [{
            ...
            value: function(t, e) {
                ...
                if (s.comboCharts) {
                    ...
                    c.series.length > 0 && v.push(p.draw(c.series, "candlestick", c.i)),
  ...
  * Copyright (c) 2016 Wout Fierens; Licensed MIT */
    ...
    function() {
        ...
        function a(t) {
            ...
            case "A":
                e = function(t, e) {
                    var i, a, s, r, o, n, l, h, c, d, g, u, f, p, x, b, v, m, y, w, k, A, S, C, L, P, I = Math.abs(e[1]), T = Math.abs(e[2]), M = e[3] % 360, z = e[4], X = e[5], E = e[6], Y = e[7], F = new SVG.Point(t), R = new SVG.Point(E,Y), D = [];
